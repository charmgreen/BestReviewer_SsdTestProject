...
void ShellCommandFactory::GetCmdType() {
    if (CommandToken[0] == "write")
        result->eCommand = ShellCmdType::Write;
    else if (CommandToken[0] == "read")
        result->eCommand = ShellCmdType::Read;
    else if (CommandToken[0] == "exit")
        result->eCommand = ShellCmdType::Exit;
    else if (CommandToken[0] == "help")
        result->eCommand = ShellCmdType::Help;
    else if (CommandToken[0] == "fullwrite")
        result->eCommand = ShellCmdType::FullWrite;
    else if (CommandToken[0] == "fullread")
        result->eCommand = ShellCmdType::FullRead;
    else if (CommandToken[0] == "testapp1")
        result->eCommand = ShellCmdType::TestApp1;
    else if (CommandToken[0] == "testapp2")
        result->eCommand = ShellCmdType::TestApp2;
    else {
